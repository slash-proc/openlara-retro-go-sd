...
export const DEFAULT_POLICY = {
  ...
  // 512 pages = 32 MiB. Measured, not copied: the module peaks at 255 pages
  // (15.9 MiB) converting LEVEL10C, and every one of the 21 TR1 PC levels was
  // measured rather than sampled -- a TR1 PC release ships exactly these
  // files, so there is no larger unseen case to leave headroom for.
  maxMemoryPages: 512,       // 32 MiB ceiling on declared memory growth
